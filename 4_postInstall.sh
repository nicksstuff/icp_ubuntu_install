...
if [[ $DO_COMM == "y" ||  $DO_COMM == "Y" ]]; then
  ~/INSTALL/POST_INSTALL/1_command_line.sh
else
...
if [[ $DO_LDAP == "y" ||  $DO_LDAP == "Y" ]]; then
  ~/INSTALL/POST_INSTALL/2_ldap.sh
else
...
if [[ $DO_AM == "y" ||  $DO_AM == "Y" ]]; then
  ~/INSTALL/POST_INSTALL/4_alert_manager.sh
else
...
if [[ $DO_CAL == "y" ||  $DO_CAL == "Y" ]]; then
  ~/INSTALL/POST_INSTALL/5_calico_cl.sh
else
...
if [[ $DO_STF == "y" ||  $DO_STF == "Y" ]]; then
  ~/INSTALL/POST_INSTALL/6_demo_assets.sh
else
